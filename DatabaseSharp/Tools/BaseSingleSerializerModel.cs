...
{
	/// <summary>
	/// Base implementation model for a single model serialization/deserialization.
	/// </summary>
	...
	public class BaseSingleSerializerModel<TIn, TOut, TEmpty>(IDBClient client, string targetSTP)
